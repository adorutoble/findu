                ...
                <div class="grid grid-cols-2 mb-6 gap-6">
                    ...
                    <div class="bg-white shadow-sm rounded-2xl flex overflow-hidden p-4">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <div class="flex justify-between items-center mt-3">
                                <span class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($brt->tanggal_rilis)->translatedFormat('l, d F Y') }}</span>
                    ...
                    <div class="bg-white shadow-sm rounded-2xl flex overflow-hidden p-4">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <div class="flex justify-between items-center mt-3">
                                <span class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($brt->tanggal_rilis)->translatedFormat('l, d F Y') }}</span>
                                <a href="#" class="text-blue-600 text-xs font-semibold flex items-center hover:underline">
                                    Selengkapnya
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/>
                                    </svg>
